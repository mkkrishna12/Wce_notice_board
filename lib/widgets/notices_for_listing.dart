...
class NoticeForListing {
  ...
  ///Notice will be displayed till this date
  String noticeRegard;

  ///The Faculty name who has entered notice
  String noticeId;

  ///Notice id generated in database
  String FacultyId;

  ///Faculty id generated in database
  bool fy, sy, ty, btech;

  ///the notes will be shown selected years
